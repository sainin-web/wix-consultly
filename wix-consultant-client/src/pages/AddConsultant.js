...
function AddConsultant() {
  ...
  const submitConsultantData = useCallback(async () => {
    ...
    const token = await getAppBridgeToken(null);
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_BACKEND_HOST}/api/api-consultant/add-consultant/${adminIdLocal}`,
        {
          method: "POST",
          body: form,
          headers: {
  ...
  const updateConsultantData = async () => {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_BACKEND_HOST}/api/api-consultant/update-consultant/${consultantId}`,
        {
          method: "PUT",
          body: form,
          headers: {
  ...
  const getConsultantById = async () => {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_BACKEND_HOST}/api/api-consultant/consultantid/${consultantId}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
